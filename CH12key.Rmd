...
Beyond just centering variables, *standarding predictors can also be helpful. This puts them on the same scale, so it is easier to identify the most important variables.*

\vfill
A common standardization approach is using a z-score, *substracting the mean and dividing by the standard deviation.*
